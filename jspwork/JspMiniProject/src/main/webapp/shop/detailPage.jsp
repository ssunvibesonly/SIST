...
<body>
	...
	<table style="width:800px;">
		...
		<td style="width:500px;">
			<div id="photo">
				<img alt="" src="shopsave/<%=dto.getPhoto() %>" class="img-thumnail large">
			</div>
		</td>
		<td>
			...
			<div style="margin-top: 100px;margin-left: 50px;">
				...
				<button type="button" class="btn btn-warning" onclick="location.href='index.jsp?main=shop/shoplist.jsp'">상품 목록</button>
			</div>
		</td>
		</tr>
	</table>
