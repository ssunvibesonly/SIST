...
<div class="container mt-3">
      ...
      <%}
           %>
            ...
            <%if(i==0)
               {%>
               <img src="./image/1st.png" style="width: 200px; margin-bottom: 5px">
               <%}
               
               else if(i==1) {%>
                 <img src="./image/2nd.png" style="width: 200px; margin-bottom: 5px">
               <%}
               
               else if(i==2){%>
                <img src="./image/3rd.png" style="width: 200px; margin-bottom: 5px">                    
               <%}
               
               else if(i==3){%>
                   <img src="./image/4th.png" style="width: 200px; margin-bottom: 5px">
               <%}%>  
            ...
            <br><b style="white-space: nowrap;"><%=dto.getMv_title()%></b><br>
