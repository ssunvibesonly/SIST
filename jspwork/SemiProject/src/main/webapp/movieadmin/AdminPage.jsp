            ...
            <tr>
               <td align="center">
                  <div
                     ...
                     onclick="location.href='index_admin.jsp?main=member/memberlist.jsp'" align="center">
               ...
               <td align="center">
                  <div
                     style="width: 300px; height: 320px; border-right: 1px solid silver; cursor: pointer; background-color: black;"
                     onclick="location.href='index_admin.jsp?main=movieadmin/listAdmin.jsp'" align="center">
               ...
               <td>
                  <div
                     ...
                     onclick="location.href='index_admin.jsp?main=shop/adminlist.jsp'" align="center">
