        ...
        success: function(data){
         ...
         // pagination 컨트롤을 그리는 코드
            ...
            if (startPage>=1 && currentPage > 1) {
                ...
                s += "<a class='page-link prev' style='cursor:pointer;'><i class='bi bi-arrow-left'></i></a>";
                s += "</li>";
            ...
            if (endPage<=totalPage && currentPage<totalPage) {
                s += "<li class='page-item active'>";
                s += "<a class='page-link next' style='cursor:pointer;'><i class='bi bi-arrow-right'></i></a>";
                s += "</li>";
      ...
      <div class="detailall">
         ...
         <div style="height: 1400px;">
            ...
            %> <%= myid %>
                           ...
                           <button type="button" class="button button-first" data-type="square" id="btnadd"><b style="color: black;">등록</b></button>
               </td>
