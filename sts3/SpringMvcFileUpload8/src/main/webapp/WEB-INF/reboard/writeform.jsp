...
<div style="margin: 50px 100px;">
	<form action="insert" method="post" enctype="multipart/form-data">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2">
					<textarea style="width:480px; height:130px;" name="content" required="required"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-outline-success" style="width:100px;">저장하기</button>
